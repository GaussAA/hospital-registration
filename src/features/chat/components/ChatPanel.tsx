...
import type { StreamMessage, ConversationSummary } from "../types";
import { Search, X, MessageSquare, Trash2, Plus, ChevronDown, Maximize, Minimize, Download, ChevronRight, RefreshCw, LoaderCircle, Paperclip, Square, Send } from "lucide-react";
            ...
            return (
              ...
              >
                {isConfirming ? (
                  ...
                  >
                    <MessageSquare size={14} stroke={isActive ? "#6366f1" : mutedColor} className="flex-shrink-0" />
              ...
              <div className="w-full space-y-2 max-w-xs">
                {QUICK_ACTIONS.map((action, i) => (
                  ...
                  >
                    ...
                    <ChevronRight size={14} stroke={mutedColor} />
                  </button>
                ))}
              </div>
            </div>
