    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button onClick={() => router.push("/hospitals")}
          className="flex items-center gap-1.5 rounded-xl border border-gray-300 dark:border-gray-600 px-4 py-2.5 text-sm text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
        >
      ...
      {activeCount > 0 && (
        <div className="flex flex-wrap items-center gap-2 text-xs">
          <span className="text-gray-400 dark:text-gray-500">当前筛选：</span>
          {currentCity && (
